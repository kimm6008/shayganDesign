...
<head>
    ...
    <link rel="stylesheet" id="font-awesome-four-css" href="" type="text/css" media="all">
    <link href="http://fonts.googleapis.com/css?family=Open+Sans:400,300,700" rel="stylesheet" type="text/css">
    <link rel="stylesheet" href="{{asset('css/MainPageCss/style.css')}}" type="text/css" media="all">
...
<body style="">
<nav class="vertical-menu on-hover-show close">
    <a class="showMenu animated"><i class="remove back"></i></a>
    <h3 class="text-center animated">
        <a href="index.html">Flat Metro</a>
    </h3>
    <form id="search" class="searchform animated" action="" role="search" method="get" accept-charset="UTF-8">
        <div class="container-inline">
            <div class="form-item form-type-textfield form-item-search-block-form">
                <label class="element-invisible" for="edit-search-block-form--2">Search</label>
                <input title="Enter the terms you wish to search for." class="small-8 columns form-text" type="text"
                       id="edit-search-block-form--2" name="s" value="" size="15" maxlength="128">
            </div>
            <button class="postfix small-4 columns form-submit" id="edit-submit--2" name="op" value="Search"
                    type="submit">Search
            </button>
        </div>
    </form>
    <br class="animated">
    <br class="animated">
    <div class="menu-menu-1-container animated">
        <ul id="menu-menu-1" class="menu-list">
            <li>
                <a href="index.html#home"><i class="fa-home fa"></i>Dashboard</a>
            </li>
            <li>
        ...
        <div class="row metro-panel">
            <div class="large-12 columns">
                <div class="row menu-row">
                    ...
                    <div class="large-4 columns menu-button text-right animated animate fadeInRightBig"
                         style="display: block;">
                ...
                <div class="row">
                    ...
                    <div class="four large-4 columns animated animate fadeInRightBig" style="display: block;">
                        <div class="row">
                            ...
                            <div class="twelve large-12 columns space testimonials-box medium">
                                <div class="color-3">
                                    ...
                                    <ul class="testimonials rslides rslides4">
                                        <li id="rslides4_s0" class=""
                                            style="display: list-item; float: none; position: absolute; opacity: 0; z-index: 1; transition: opacity 500ms ease-in-out 0s;">
                                            <blockquote>
                                                <p>To awaken interest and kindle enthusiasm is the sure way to teach
                                                    easily and successfully.</p>
                                                <cite>Tryon Edwards</cite>
                                            </blockquote>
                                        </li>
                                        <li id="rslides4_s1"
                                            style="display: list-item; float: left; position: relative; opacity: 1; z-index: 2; transition: opacity 500ms ease-in-out 0s;"
                                            class="rslides4_on">
                                            <blockquote>
                                                <p>Any genuine teaching will result, if successful, in knowing how to
                                                    bring about a better condition of things than existed earlier.</p>
                                        ...
                                        <li id="rslides4_s2"
                                            ...
                                            class="">
                                            <blockquote>
                                                <p>One looks back with appreciation to the brilliant teachers, but with
                                                    gratitude to those who touched our human feelings.</p>
                                                <cite>Carl Jung</cite>
                                            </blockquote>
                                        </li>
                                        <li id="rslides4_s3"
                                            ...
                                            class="">
                                            <blockquote>
                                                <p>The art of handling university students is to make oneself appear,
                                                    and this almost ostentatiously, to be treating them as adults…</p>
                            ...
                            <div class="twelve large-12 columns space work-box big">
                                <div>
                                    ...
                                    <div class="projects-slider">
                                        <ul class="rslides rslides1" style="max-width: 400px;">
                                            <li id="rslides1_s0" class=""
                                                style="display: list-item; float: none; position: absolute; opacity: 0; z-index: 1; transition: opacity 500ms ease-in-out 0s;">
                                                <a href="#t">
                                                    <img width="400" height="400" src="assets/images/2.jpg"
                                                         alt="1j5JfNg">
                                                </a>
                                            </li>
                                            <li id="rslides1_s1"
                                                ...
                                                class="">
                                                <a href="#">
                                                    <img width="400" height="400" src="assets/images/3.jpg"
                                                         alt="1m7ZhI3">
                                                </a>
                                            </li>
                                            <li id="rslides1_s2"
                                                ...
                                                class="">
                                                <a href="#">
                                                    <img width="400" height="400" src="assets/images/4.jpg"
                                                         alt="1a2n0Ck">
                                                </a>
                                            </li>
                                            <li id="rslides1_s3"
                                        ...
                                        <a href="#" class="rslides_nav rslides1_nav prev"></a><a href="#"
                                                                                                 class="rslides_nav rslides1_nav next"></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="color-8">
                                    ...
                                    <div class="wd-tweets">
                                        <ul class="rslides rslides3">
                                            <li id="rslides3_s0" class="animated"
                                                style="display: list-item; float: none; position: absolute; opacity: 0; z-index: 1; transition: opacity 500ms ease-in-out 0s;">
                                                @isaacasante We'd love to do an Envato Live event in as many places as
                                                we can if this goes well :) ^TK #envatolive
                                            </li>
                                            <li id="rslides3_s1"
                                                style="display: list-item; float: left; position: relative; opacity: 1; z-index: 2; transition: opacity 500ms ease-in-out 0s;"
                                                class="animated rslides3_on">@Jordan_McNamara We never let the dream
                                                die! :D ^TK
                                            </li>
                                        </ul>
                                        <a href="#" class="rslides_nav rslides3_nav prev"></a><a href="#"
                                                                                                 class="rslides_nav rslides3_nav next"></a>
                                    </div>
                                </div>
                            </div>
                            <div class="six small-6 columns contact-box space">
                ...
                <div class="copyright" style="display: block;">© 2013 Flat Metro All rights reserved.</div>
            </div>
        </div>
    </section>
        ...
        <div class="row clear-fix">
            <div class="large-12 columns page-sub-title text-center">
                <p>In hac habitasse platea dictumst. Pellentesque in aliquet risus. In at consequat ipsum. Aenean leo
                    elit, imperdiet ac volutpat ornare, mattis vel est. Aliquam rhoncus mi non tortor sodales placerat
                    vel in dolor. Praesent lorem tellus, porta vitae enim sit amet, interdum imperdiet.</p>
            </div>
                ...
                <div class="large-4 columns">
                    <div class="service-div text-center">
                        ...
                        <p class="text-left">Cras metus sem, mattis et volutpat ac, dignissim quis arcu. Fusce pretium
                            suscipit mauris, in rhoncus arcu. Pellentesque malesuada dolor a lorem ultrices dapibus vel
                            eget neque.</p>
                    </div>
                </div>
                <div class="large-4 columns">
                ...
                <li>
                    <div class="team-member-item">
                        <div class="team-member-picture">
                            <img width="400" height="300" src="assets/images/9.jpg" alt="doctor">
                        </div>
                        ...
                        <div class="team-member-desc text-left">
                            <p>Bryan is the massa et dolor imperdiet vehicula a at sapien. Sed magna ipsum, placerat non
                                neque a, bibendum bibendum dui. Quisque tempus in mauris vitae tempor. Nullam dapibus,
                                turpis a blandit sollicitudin, justo mi iaculis augue, nec placerat orci mauris ac sem.
                                Nam rutrum vestibulum nibh, quis interme.</p>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="team-member-item">
                        <div class="team-member-picture">
                            <img width="400" height="300" src="assets/images/10.jpg" alt="Smiling man">
                        </div>
                        ...
                        <div class="team-member-desc text-left">
                            <p>Joan is the brain of team Curabitur euismod turpis vitae metus porttitor, id commodo arcu
                                malesuada. Mauris a placerat elit. Donec pharetra sem dui, in hendrerit lacus dictum
                                quis. Maecenas urna mi, adipiscing non posuere non, blandit eu nisi. Integer laoreet
                                venenatis nunc, ut aliquam eros ornare non.</p>
                        </div>
                    </div>
                </li>
                <li>
                    <div class="team-member-item">
                        <div class="team-member-picture">
                            <img width="400" height="300" src="assets/images/11.jpg" alt="College student">
                        </div>
                        <h3 class="team-member-name">Carl Vandiresh</h3>
                        <h4>Designer</h4>
                        <div class="team-member-desc text-left">
                            <p>Carl is the adipiscing non posuere non, blandit eu nisi. Integer laoreet venenatis nunc,
                                ut aliquam eros ornare non. Vestibulum sit amet condimentum mauris, at dignissim arcu.
                                Maecenas consequat leo ultricies posuere sagittis. Suspendisse in risus iaculis, posuere
                                turpis eget, volutpat lorem. Aliquam erat.</p>
                        </div>
                    </div>
                </li>
            </ul>
                    ...
                    <div id="content">
                        ...
                        <div class="row">
                                ...
                                <div class="project-images">
                                    <div class="item-list">
                                        <ul class="rslides rslides2">
                                            <li id="rslides2_s0" class="rslides2_on"
                                                style="display: block; float: left; position: relative; opacity: 1; z-index: 2; transition: opacity 500ms ease-in-out 0s;">
                                                <a href="#">
                                                    <img width="500" height="380" alt="13tndZF"
                                                         class="attachment-project-thumb" src="assets/images/12.jpg">
                                                </a>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div class="large-6 columns project-content">
                                ...
                                <p>Proin egestas nisl in nibh condimentum, nec ornare erat egestas. Fusce dui est,
                                    gravida ut sem vitae, tincidunt pharetra massa. In erat libero, fermentum suscipit
                                    pretium vel, eleifend vitae odio. Nullam quis mi velit. Cras ut aliquet orci.</p>
                                <p>Curabitur sollicitudin massa quis magna cursus, a auctor dolor imperdiet. Nullam
                                    ultrices pretium mauris, vel fermentum nisl venenatis ac. Aenean adipiscing lorem a
                                    purus viverra, eu hendrerit est consequat. Duis felis mauris, imperdiet eu erat a,
                                    bibendum egestas arcu. Morbi at pulvinar quam, eget vulputate dolor. Mauris id urna
                                    diam. Proin gravida luctus dolor, at aliquet eros pretium id. Donec accumsan leo
                                    tellus, quis interdum felis elementum a</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <li class="">
                                <article class="article">
                                    ...
                                    <div class="post-body">
                                        ...
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Integer vel justo
                                            metus. Ut sit amet venenatis tellus. Quisque ornare dignissim…</p>
                                    </div>
                                </article>
                            </li>
                            <li class="">
                                <article class="article">
                                    ...
                                    <div class="post-body">
                                        ...
                                        <p>Ut a lorem odio. Morbi vulputate nec orci sit amet iaculis. Sed eleifend nisi
                                            lorem, sit amet sagittis nunc volutpat…</p>
                                    </div>
                                </article>
                            </li>
                            <li class="">
                                <article class="article">
                                    ...
                                    <div class="post-body">
                                        ...
                                        <p>Etiam diam augue, aliquam vitae aliquet et, sagittis non orci. In hac
                                            habitasse platea dictumst. Nulla eget felis nec ligula…</p>
                                    </div>
                                </article>
                            </li>
                            <li class="">
                                <article class="article">
                                    <a href="#" title="Praesent tincidunt vulputate">
                                        <img width="800" height="380" src="assets/images/24.jpg"
                                             alt="sparrow-9950_1280">
                                    </a>
                                    <div class="post-body">
                                        <h2><a href="#">Praesent tincidunt vulputate</a></h2>
                                        <p>Fusce non hendrerit ante. Curabitur in libero neque. Nulla at vestibulum
                                            massa. Fusce feugiat tellus fermentum lorem cursus, at vestibulum…</p>
                                    </div>
                                </article>
                            </li>
                            <li class="">
                                <article class="article">
                                    ...
                                    <div class="post-body">
                                        ...
                                        <p>Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere
                                            cubilia Curae; Proin facilisis, velit non fringilla pharetra, elit…</p>
                                    </div>
                                </article>
                            </li>
                            <li class="">
                                <article class="article">
                                    <a href="#" title="Hello world!">
                                        <img width="800" height="380" src="assets/images/26.jpg"
                                             alt="seagull-183229_1920">
                                    </a>
                                    <div class="post-body">
...
<script type="text/javascript" src="{{asset('js/MainPageJs/comment-reply.min.js')}}"></script>
<script type="text/javascript" src="{{asset('js/MainPageJs/custom.modernizr.js')}}"></script>
<script type="text/javascript" src="{{asset('js/MainPageJs/foundation/foundation.min.js')}}"></script>
<script type="text/javascript" src="{{asset('js/MainPageJs/modernizr.custom.js')}}"></script>
<script type="text/javascript" src="{{asset('js/MainPageJs/foundation.section.js')}}"></script>
...
<script type="text/javascript" src="{{asset('js/MainPageJs/jquery.form.min.js')}}"></script>
