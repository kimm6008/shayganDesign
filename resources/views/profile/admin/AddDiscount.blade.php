<form method="post" action="{{route('ProductDiscount.store')}}">
    @csrf
    ...
    <x-admin-form.input-text id="price" name="price" label="تخفیف مقداری"  faicon="fa-star" :required="true"/>
    <x-admin-form.input-numeric id="price_percent" max="100" min="0" name="price_percent" label="تخفیف درصدی"  faicon="fa-star" :required="true"/>
